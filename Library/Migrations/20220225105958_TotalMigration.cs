        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullPrice_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FullPrice_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CurrentPrice_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CurrentPrice_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false, defaultValue: 1000),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paid_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
